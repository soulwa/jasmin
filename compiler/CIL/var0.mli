...
module Var :
 sig
  ...
  module Mv :
   sig
    type 'to0 rt_ = { dft : (var -> 'to0); tbl : 'to0 Ident.Ident.Mid.t Mt.t }

    val dft : 'a1 rt_ -> var -> 'a1

    val tbl : 'a1 rt_ -> 'a1 Ident.Ident.Mid.t Mt.t
...
module type FvT =
 sig
  ...
  val empty : (Var.var -> 'a1) -> 'a1 t

  val get : 'a1 t -> Var.var -> 'a1

  val set : 'a1 t -> Var.var -> 'a1 -> 'a1 t
 end
   ...
   sig
    ...
    module Raw :
     sig
      ...
      | R_min_elt_2 of tree * Int.Z_as_Int.t * tree * Equality.sort * 
         tree * Int.Z_as_Int.t * tree * Equality.sort * tree * elt option
         * coq_R_min_elt

      type coq_R_max_elt =
      | R_max_elt_0 of tree
      | R_max_elt_1 of tree * Int.Z_as_Int.t * tree * Equality.sort * tree
      | R_max_elt_2 of tree * Int.Z_as_Int.t * tree * Equality.sort * 
         tree * Int.Z_as_Int.t * tree * Equality.sort * tree * elt option
         * coq_R_max_elt
